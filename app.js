...
function showVersion() {
  ...
  badge.textContent = 'version 0.1.33';
...
function initApp() {
  ...
  // Render Teacher (unchanged from v0.1.32) …
  function renderTeacher(t) {
    /* … existing teacher + admin code here … */
  }
  ...
  function renderDrillsWithDate(drills, dateKey, student, isLate) {
    ...
    nextBtn.onclick = () => {
      ...
      if (idx < drills.length - 1) {
        ...
        // final Submit: leave button visible but disabled
